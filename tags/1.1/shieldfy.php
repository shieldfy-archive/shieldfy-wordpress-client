...
function shieldfy_deactivation() {
	...
	@file_put_contents($root.'/shieldfy.php', '<?php');
...
function shieldfy_admin_notice() {
	...
	if($shieldfy_active == false){
		echo '<div style="padding: 10px; margin: 5px; background: rgb(229, 196, 26) none repeat scroll 0px 0px; color: rgb(64, 62, 61);"> <img src="'.plugin_dir_url( __FILE__ ).'/shieldfy.png'.'" style="vertical-align:-5px;">
